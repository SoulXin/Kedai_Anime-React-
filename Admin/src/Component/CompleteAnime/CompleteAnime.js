...
export default class CompleteAnime extends Component {
    ...
    componentDidMount(){
        ...
        if(this._isMounted){
            axios({
                method : "GET",
                url : 'http://localhost:5000/complete/check_complete_developer',
    ...
    render() {
        ...
        return (
            <div className="container"style = {{backgroundColor : 'white',borderRadius : '15px',marginTop : '100px',marginBottom : '50px'}}>
                <div className = "row">
                    <h4 className = "col-12 bg-success" style = {{borderRadius : '15px 15px 0px 0px',padding : '10px'}}>Anime Yang Telah Selesai</h4>
                </div>
                <div className="row">
