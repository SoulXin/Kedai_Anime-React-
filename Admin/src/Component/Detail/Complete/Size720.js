    ...
    render() {
        ...
        googledrive.map((list,index) => {
            return <tr key = {index}>
                ...
                <td>
                    <button className = "btn btn-primary" onClick = {()=> this.handleUpdate("googledrive",list.googledrive_id,index,list.complete_id,list.size720)} style = {{width : '160px'}}>Update Episode {list.episode}</button>
                </td>
                <td>
        ...
        zippyshare.map((list,index) => {
            return <tr key = {index}>
                ...
                <td>
                    <button className = "btn btn-primary" onClick = {()=> this.handleUpdate("zippyshare",list.zippyshare_id,index,list.complete_id,list.size720)} style = {{width : '160px'}}>Update Episode {list.episode}</button>
                </td>
                <td>
                    ...
                    <div className = "col-6 mt-2" style = {{textAlign : 'center'}}>
                        ...
                        <div className = "row px-2">
                            <div className = "col-12 px-0"  style = {{border : '1px solid black',borderRadius : '5px'}}>
                                ...
                                <button className = "btn btn-primary mt-1 mb-1" onClick = {()=>this.handleShow("googledrive")}>Tambah Link Googledrive versi 720</button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className = "col-6 mt-2" style = {{textAlign : 'center'}}>
                        ...
                        <div className = "row px-2">
                            <div className = "col-12 px-0"  style = {{border : '1px solid black',borderRadius : '5px'}}>
                                ...
                                <button className = "btn btn-primary mt-1 mb-1" onClick = {()=>this.handleShow("zippyshare")}>Tambah Link Zippyshare versi 720</button>
                            </div>
                        </div>
                    </div>
