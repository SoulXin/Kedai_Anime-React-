...
export default class DetailOnGoing extends Component {
    ...
    handleComplete = () => {
        ...
        axios({
            method : 'DELETE',
            url : `http://localhost:5000/ongoing/change_to_complete_anime/${anime_id}`,
            cancelToken : this.source.token,
        })
        .then(response => {
                        ...
                        <div className = "row">
                            ...
                            <div className = "col-6" style = {{textAlign : 'left'}}>
                                ...
                                <div className = "row">
                                    ...
                                    <button className = "col-5 btn btn-success mx-auto" style = {{width : '100%'}} onClick = {this.handleComplete}>Complete Anime</button>
                                </div>
                            </div>
                        </div>
                    </div>
