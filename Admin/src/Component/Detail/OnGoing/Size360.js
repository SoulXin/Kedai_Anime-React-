    ...
    render() {
        ...
        googledrive.map((list,index) => {
            return <tr key = {index}>
                ...
                <td>
                    <button className = "btn btn-primary" onClick = {()=> this.handleUpdate("googledrive",list.googledrive_id,index,list.anime_id,list.size360)} style = {{width : '160px'}}>Update Episode {list.episode}</button>
                </td>
                <td>
        ...
        zippyshare.map((list,index) => {
            return <tr key = {index}>
                ...
                <td>
                    <button className = "btn btn-primary" onClick = {()=> this.handleUpdate("zippyshare",list.zippyshare_id,index,list.anime_id,list.size360)} style = {{width : '160px'}}>Update Episode {list.episode}</button>
                </td>
                <td>
                    <button className = "btn btn-danger" style = {{width : '160px'}} onClick = {()=> this.handleDelete(index,list.on_going_id)}>Hapus Episode {list.episode}</button>
                </td>
